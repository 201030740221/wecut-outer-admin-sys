...
class FeedBack extends React.Component {
  render() {
    ...
    let classes = SP.classSet({'has-feedback': false, 'is-validating': this.props.validating, 'has-error': this.props.error, 'has-warning': this.props.warning, 'has-success': this.props.success});
    return (
      <div className={classes}>
        {this.props.children}
        {tips}
